...
<em>udev daemon</em> to create a symbolic link with the appropriate
permissions for the device file. In order to support touch devices in
other VRUI-based applications, one only needs to copy the
